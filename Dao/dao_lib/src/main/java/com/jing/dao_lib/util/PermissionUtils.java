...
/**
 * Created by 陈永镜 on 2016/12/5.
 * description : 权限申请
 */

public class PermissionUtils {
    private static PermissionUtils instance;
    public String[] permissions = new String[]{Manifest.permission.INTERNET,Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE};
     ...
     *
     * @param activity
     * @param permissions new String[]{ Manifest.permission.CAMERA,Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE
     *                    }
     */
    ...
    private void requestPermissionsSafely(String[] permissions, int requestCode, Activity activity) {
        Log.w(getClass().getName(), "permissions=" + permissions.length);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
